...
export const FeaturedProductItem = (props: FeaturedProductItemProps) => {
    ...
    return(
       <div data-testid="FeaturedProduct" className={`${featuredProductClass} h-[420px] w-[400px] p-8 max-w-md mx-auto flex flex-col content-center items-center  justify-end rounded-md shadow-md`}>
