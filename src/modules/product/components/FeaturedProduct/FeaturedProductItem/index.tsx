...
export const FeaturedProductItem = (props: FeaturedProductItemProps) => {
    ...
    return(
       <div data-testid="FeaturedProduct" className={`${featuredProductClass} h-[420px] w-full mx-w-[400px] p-8 max-w-md mx-auto flex flex-col content-center items-center  justify-end rounded-md shadow-md`}>
            <Card imgAlt={title} imgSrc={image}  class_card_image="h-2/3 ">
                <div className="banner-info mt-4 flex flex-col ">
                    <h2 className="font-open-sans text-2xl font-bold tracking-tight dark:text-white overflow-hidden line-clamp-1" >{title}</h2>
